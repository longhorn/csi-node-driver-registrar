...
- Updated dependencies to Kubernetes 1.37 ([#619](https://github.com/kubernetes-csi/node-driver-registrar/pull/619), [@jsafrane](https://github.com/jsafrane))
...
- k8s.io/kubelet: v0.36.1 → v0.37.0
